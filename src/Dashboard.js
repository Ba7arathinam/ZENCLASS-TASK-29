            ...
            <div className="row dash">
                ...
                <div className="col-xl-3 col-md-6 mb-4">
                    <div class="card text-white bg-secondary mb-3" style={{ maxWidth: "18rem" }}>
                        ...
                        <div class="card-body">
                            <h5 class="card-title">School Notes</h5>
                            <p class="card-text"> The href attribute is required for an anchor to be keyboard accessible. Provide a valid, navigable address as the href value. If you can
not provide an href, but still need the element to resemble a link, use a button and change it with appropriate styles</p>
                        </div>
                        <div />
                    </div>
                </div>
